...
function Footer() {
  return (
    <footer className="text-gray-500/80 pt-8 px-6 md:px-16 lg:px-24 xl:px-32 bg-white">
      <div className="flex flex-wrap justify-between gap-12 md:gap-6">
        ...
        {/* Links */}
        <FooterColumn title="COMPANY" links={["About", "Careers", "Press", "Blog", "Partners"]} />
        <FooterColumn title="SUPPORT" links={["Help Center", "Safety Information", "Cancellation Options", "Contact Us", "Accessibility"]} />
...
const SocialIcon = ({ children }) => (
  <svg
    className="w-6 h-6 hover:text-black cursor-pointer transition"
    fill="currentColor"
    viewBox="0 0 24 24"
  >
    {children}
